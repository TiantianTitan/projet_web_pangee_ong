                    ...
                    <div class="webui-popover-content">
                        <div class="course-popover-content">
                            ...
                            <div class="course-title">
                                <a href="<?php echo site_url('#'.slugify($top_course['title']).'/'.$top_course['id']); ?>"><?php echo $top_course['title']; ?></a>
                            </div>
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="course-carousel">
                    ...
                    <div class="course-box-wrap">
                        <a href="<?php echo site_url('#/'.slugify($latest_course['title']).'/'.$latest_course['id']); ?>">
                            <div class="course-box">
                                <div class="course-image">
